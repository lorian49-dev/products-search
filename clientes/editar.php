...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .client-avatar { width: 60px; height: 60px; background: #667eea; color: white; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 1.5em; font-weight: bold; }
    ...
    <div class="dashboard-container">
        ...
        <div class="header">
            <div class="header-top">
                ...
                <div>
                    <a href="ver.php?id=<?php echo $id_cliente; ?>" class="btn btn-secondary">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <div style="text-align: center; margin-top: 40px; padding-top: 20px; border-top: 2px solid #eee;">
                    ...
                    <a href="eliminar.php?id=<?php echo $id_cliente; ?>" class="btn btn-danger">
