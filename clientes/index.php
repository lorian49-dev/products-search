...
<body>
    <div class="dashboard-container">
        ...
        <div class="header">
            <div class="header-top">
                ...
                <div>
                    ...
                    <a href="ver.php?action=estadisticas" class="btn btn-primary">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="acciones">
                                    <a href="ver.php?id=<?php echo $id_cliente; ?>" 
                                       class="btn-action btn-view" title="Ver Detalles">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="editar.php?id=<?php echo $id_cliente; ?>" 
                                       class="btn-action btn-edit" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <?php if($_SESSION['admin_rol'] == 1): ?>
                                    <a href="eliminar.php?id=<?php echo $id_cliente; ?>" 
                                    ...
                                    <?php endif; ?>
                                    <?php if($carritos['total'] > 0): ?>
                                    <a href="acciones.php?action=limpiar_carrito&id=<?php echo $id_cliente; ?>" 
        ...
        <div style="text-align: center; margin-top: 30px;">
            ...
            <a href="../vendedores/index.php" class="btn btn-success">
    ...
    <script>
        function buscarClientes() {
            ...
            if (busqueda) {
                window.location.href = 'index.php?busqueda=' + encodeURIComponent(busqueda);
            }
        }
