...
<body>
        ...
        <div class="header">
            <div class="header-top">
                ...
                <div>
                    ...
                    <a href="dashboard-index-watch.php?action=estadisticas" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="acciones">
                                            <a href="dashboard-index-watch.php?id=<?php echo $id_cliente; ?>"
                                                class="btn-action btn-view" title="Ver Detalles">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="dashboard-index-edit.php?id=<?php echo $id_cliente; ?>"
                                                class="btn-action btn-edit" title="Editar">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <?php if ($_SESSION['admin_rol'] == 1): ?>
                                                <a href="dashboard-index-delete.php?id=<?php echo $id_cliente; ?>"
    ...
    <script>
        function buscarClientes() {
            ...
            if (busqueda) {
                window.location.href = 'dashboard-index.php?busqueda=' + encodeURIComponent(busqueda);
            }
        }
