...
if (!$id_vendedor || !$action) {
    header('Location: seller-dashboard-admin-index');
    exit();
}
...
if (mysqli_num_rows($result_check) === 0) {
    echo "<script>
        ...
        window.location.href = 'seller-dashboard-admin-index';
    </script>";
    exit();
}
        ...
        if ($total_catalogos > 0) {
            ...
            try {
                ...
                echo "<script>
                    ...
                    window.location.href = 'seller-dashboard-admin-watch.php?id=$id_vendedor';
                </script>";
