    ...
    <div class="dashboard-container">
        ...
        <div class="section">
            ...
            <div style="display: flex; gap: 10px; flex-wrap: wrap;">
                ...
                <a href="../productos/index.php?vendedor=<?php echo $id_vendedor; ?>" class="btn btn-info">
                    <i class="fas fa-boxes"></i> Ver Productos
                </a>
                <a href="../catalogo/index.php?vendedor=<?php echo $id_vendedor; ?>" class="btn btn-warning">
                ...
                <?php endif; ?>
                <a href="../usuarios/editar.php?id=<?php echo $id_vendedor; ?>" class="btn btn-secondary">
