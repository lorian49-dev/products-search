    ...
    <div class="dashboard-container">
        ...
        <div class="table-container">
                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="acciones">
                                    <a href="ver.php?id=<?php echo $id_vendedor; ?>" 
                                       class="btn-action btn-view" title="Ver Detalles">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="editar.php?id=<?php echo $id_vendedor; ?>" 
                                       class="btn-action btn-edit" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <?php if($_SESSION['admin_rol'] == 1): ?>
                                    <a href="eliminar.php?id=<?php echo $id_vendedor; ?>" 
            ...
            <div style="padding: 50px 20px; text-align: center; color: #666;">
                ...
                <a href="../clientes/index.php" class="btn btn-primary" style="margin-top: 20px;">
        ...
        <div style="text-align: center; margin-top: 30px;">
            ...
            <a href="../clientes/index.php" class="btn btn-success">
